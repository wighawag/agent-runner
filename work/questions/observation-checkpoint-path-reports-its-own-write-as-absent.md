<!-- dorfl-sidecar: item=observation:checkpoint-path-reports-its-own-write-as-absent type=observation slug=checkpoint-path-reports-its-own-write-as-absent allAnswered=false -->

Item: [`observation:checkpoint-path-reports-its-own-write-as-absent`](../notes/observations/checkpoint-path-reports-its-own-write-as-absent.md)

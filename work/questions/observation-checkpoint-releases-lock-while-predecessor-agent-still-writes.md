<!-- dorfl-sidecar: item=observation:checkpoint-releases-lock-while-predecessor-agent-still-writes type=observation slug=checkpoint-releases-lock-while-predecessor-agent-still-writes allAnswered=false -->

Item: [`observation:checkpoint-releases-lock-while-predecessor-agent-still-writes`](../notes/observations/checkpoint-releases-lock-while-predecessor-agent-still-writes.md)
